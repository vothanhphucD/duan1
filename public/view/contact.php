                    ...
                    <div class="row">
                        <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                            ...
                            <h3 class="contact-page-title">Liên hệ với chúng tôi</h3>
                                 <p class="contact-page-message mb-25">Sự rõ ràng cũng là một quá trình năng động tuân theo thói quen thay đổi của người đọc. Thật đáng ngạc nhiên khi lưu ý rằng văn học Gothic, mà ngày nay chúng ta coi là khá rõ ràng, đã có trước các hình thức văn học của con người.</p>
                                 <div class="single-contact-block">
                                     <h4><i class="fa fa-fax"></i> Địa chỉ</h4>
                                     <p>Cầu Vượt QUang Trung</p>
                                 </div>
                                 <div class="single-contact-block">
