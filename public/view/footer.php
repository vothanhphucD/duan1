                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 pb-sm-55 pb-xs-55">
                        <div class="li-shipping-inner-box">
                            ...
                            <div class="shipping-text">
                                 ...
                                 <p>Và trả lại miễn phí. Xem phần thanh toán để biết ngày giao hàng.</p>
                             </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-logo">
                            <img style="width:250px" src="./../public/view/images/logo-main.jpg" alt="Footer Logo">
                            <p class="info">
                        ...
                        <ul class="des">
                            ...
                            <li>
                                <span>Email: </span>
                                <a href="mailto://info@yourdomain.com">khangtcps32707@fpr.edu.vn</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-6">
                        ...
                        <h3 class="footer-block-title">Sản phẩm</h3>
                             <ul>
                                 ...
                                 <li><a href="#">Doanh số bán hàng tốt nhất</a></li>
                    ...
                    <div class="col-lg-4">
                        <div class="footer-block">
                            <h3 class="footer-block-title">Thêm Dõi Tôi</h3>
