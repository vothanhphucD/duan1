                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="index.php?act=add_product" method="POST"
                            ...
                            <div class="form-group">
                                <label for="exampleTextarea1">Giá mới</label>
                                <input type="text" class="form-control" id="exampleInputName1" name="sanpham_gia"
                                    placeholder="Giá">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleTextarea1">Sale mới</label> <br>
                                <input type="text" class="form-control" id="exampleInputName1" name="Sale">
                            </div>
                            <div class="form-group">
                                <label for="exampleTextarea1">Upload hình mới</label>
                                <input type="file" class="form-control" id="exampleInputName1" name="sanpham_img" placeholder="Giảm Giá">
                            </div>
                            <div class="form-group">
                                <label for="exampleTextarea1">Mô Tả mới</label> <br>
                                <textarea style="border: 1px soild pink;" name="sanpham_mota" id="sanpham_mota" cols="60" rows="5"></textarea>
                            </div>
                           
                            <input type="submit" class="btn btn-primary mr-2" name="add_product" value=" Chỉnh Sửa ">
                            <!-- <button class="btn btn-light">Trở lại</button> -->
                        </form>
                    </div>
                </div>
