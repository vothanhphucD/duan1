...
if (isset($_SESSION['s_user']) && (count($_SESSION['s_user']) > 0)) {
    ...
    $html_account = '     
        ...
        <img class="nav-profile-img mr-2" alt="" src="./admin/view/images/faces/face3.jpg">
    ...
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href="index.php?pg=admin"><img style="width:150px;height: 80px; margin-bottom: 10px; " src="./layout/images/logo-main.jpg" alt="logo"></a>
                <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="index.php?pg=admin"><img style="width:150px;height: 80px; margin-bottom: 10px; " src="./layout/images/logo-main.jpg" alt="logo"></a>
            </div>
            <ul class="nav">
                <li class="nav-item active">
                    <a class="nav-link" href="index.php?pg=admin">
                        <i class="mdi mdi-home menu-icon"></i>
                        <span class="menu-title">Trang chủ</span>
                    </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="index.php?pg=ql_tk">
                        <i class="mdi mdi-account-multiple menu-icon"></i>
                        <span class="menu-title">Quản lý tài khoản</span>
                    </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="index.php?pg=ql_dm">
                        <i class="mdi mdi-wunderlist menu-icon"></i>
                        <span class="menu-title">Quản lý danh mục</span>
                    </a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="index.php?pg=ql_sp">
